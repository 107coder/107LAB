...
<body>
    ...
    <div id="jianjie">
        <div id="return">
            <li>&nbsp;</li>
            <li>&nbsp;</li>
            <p>当前位置：<a href="lz3.php">首页</a>>>新闻公告</p>
        </div><p></p>
            <div id="abc"></div>
            <img src="../images/newslist.jpg" width="320px" height="420px">
            <div id="news9">
				...
				<?php
					...
					//4. 解析结果集,并遍历输出 <img src="images/list_icon.png" width="26px">
						while($row = mysqli_fetch_assoc($result)){
							echo "<tr height=30>";
							echo "<td><img src='../images/list_icon.png' style='width:20px;height:20px'>{$row['title']}</td>";
							echo "</tr>";
						}
					//5. 释放结果集
