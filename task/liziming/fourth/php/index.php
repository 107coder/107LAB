        ...
        <div id="xw">
            <table width="625" border="0">
				...
				<?php
					...
					//3. 执行查询，并返回结果集
						$sql2 = "select * from news order by top desc";
						$result = mysqli_query($link2,$sql2);
						
					//4. 解析结果集,并遍历输出 <img src="images/list_icon.png" width="26px">
						while($row = mysqli_fetch_assoc($result)){
							echo "<tr height=30>";
							echo "<td><a href='detail.php?id={$row['id']}'><img src='../images/list_icon.png' style='width:20px;height:20px'>{$row['title']}</a></td>";
							echo "</tr>";
						}
					//5. 释放结果集
