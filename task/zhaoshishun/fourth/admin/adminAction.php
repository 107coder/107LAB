<?php
	...
	if($_action=='add')		//添加
	    {
			...
			$re_pass = $_POST["re_password"];
				...
				if($pass == $re_pass){
						...
						//sql语句
						$sql_select = "select adminname from admin where adminname = '$user'";
						//sql语句执行
						...
						$num = mysqli_num_rows($result); 
							...
							exit;
									...
									//用户名不存在
									$sql_insert = "insert into admin(adminname,password) values('$user','$pass')";
									//插入数据
    ...
    if($_action=='update')
    {
		...
		$pass = $_POST["password"];
			...
			$sql = "update admin set adminname='$user',password='$pass' where id=$id";
