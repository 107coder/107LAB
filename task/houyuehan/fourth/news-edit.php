    ...
    <?php include "header.php"; ?>
        ...
        <?php
            ...
            if($mysqli_result&&$mysqli_result->num_rows>0){
                $news=$mysqli_result->fetch_assoc();
            }else{
                die("没有找到要修改的信息");
            }
        ...
        ?>
            ...
            <h3>编辑新闻</h3>
            <form action="news-action.php?act=update&id=<?php echo $id; ?>" method="post">
            <input type="hidden" name="id" value="<?php echo $news['id']; ?>">
                <table width="340px" border="1px">
                    ...
                    <tr>
                        ...
                        <td><textarea cols="35" rows="5" name="content"><?php echo $news['content']; ?></textarea></td>
                    </tr>
                    <tr>
