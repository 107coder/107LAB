$(function(){
     ...
     * 鼠标移入移出字体变颜色
     */
    var character1=$('.main-content>div>h3, .main-content>div>a>h3, .main-content>div>div>ul>li, .content-list ul li, .nowposition a');
    /*var character2=$('.main-content>div>div>ul>li');
    var character3=$('.content-list ul li');
    var character4=$('.nowposition a');*/
