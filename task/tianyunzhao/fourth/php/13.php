...
<html>
	...
	<body>
		...
		<div id="shoduan2">
			<a href="3.php"><img src="../img/ICON.png" style="width:850px;height:70px;position:relative;left:100px;top:20px;"></a>
		</div>
		...
		<div style="width:100%;height:5px;background-color:#4289C9;position:relative;top:0px;left:0px;text-align: center;margin: 0px auto;"></div>		
		<div style="position:absolute;top:250px;width:800px;font-size:20px;margin-left:450px;"><p><?php echo $_GET['content'];?></p></div>
