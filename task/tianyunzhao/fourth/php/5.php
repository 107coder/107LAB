...
<html>
	...
	<body>
		...
		<div class="dang1" style="width: 1000px;height: 500px;position: relative;top:180px;left:0px;font-size: 20px;">
		<div class="dang" style="width:1100px;height:30px;position:relative;top:-50px;left:0px;font-size: 20px;"><p>当前位置: <a href="disan.php">首页</a> >> <a href="#">我要留言</a></p></div>
        ...
        <div class="cc"style=" width:1100px;height:600px;margin:20px auto;position: relative;left:0px;">	
        <p style="color:#4289C9;font-size: 20px;">编辑留言信息:</p></br>
        <p><span>请输入你的邮箱:<input type="text" style="height:20px;position: relative;top:-2px;"></span></p></br>
        <p>请输入留言内容:</p>
       <textarea style="width:600px;height:400px;position:relative;top:10px;"></textarea></br></br>
       <button>发表留言</button>
        </div></div>
